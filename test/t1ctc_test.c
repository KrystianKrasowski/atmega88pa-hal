...
void
should_init_timer1_ctc_mode(void)
{
    // when
...
void
should_init_timer1_ctc_mode_resolution(uint16_t resolution)
{
    // given
...
void
should_init_timer1_ctc_mode_channel_b(uint16_t ocr1b)
{
    // given
...
void
should_run_timer1_ctc_mode(hal_timer_prescaller_t prescaller, uint8_t tccr1b)
{
    // given
...
main(void)
{
    ...
    RUN_TEST(should_run_timer1_ctc_mode,
