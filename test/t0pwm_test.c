...
void
should_init_phase_correct_pwm(void)
{
    // when
...
void
should_run_pwm_with_channel_mode(hal_t0pwm_channel_mode_t channel_a_mode,
...
void
should_run_pwm_with_duty_cycle(uint8_t channel_a_dc,
...
void
should_run_pwm_with_prescaler(hal_timer_prescaller_t presc, uint8_t tccr0b)
{
    // when
