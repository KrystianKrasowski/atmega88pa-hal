                                    ...
                                    uint8_t ocr0b)
{
  // given
  hal_t0pwm_def_t def = {
      .channel_a = {.mode = HAL_T0PWM_CHANNEL_NON_INVERTING,
                    .duty_cycle = channel_a_dc},
      .channel_b = {.mode = HAL_T0PWM_CHANNEL_NON_INVERTING,
...
void should_run_pwm_with_prescaler(hal_t0pwm_prescaller_t presc,
                                   uint8_t tccr0b)
{
  // given
  hal_t0pwm_def_t def = {
      .channel_a = {.mode = HAL_T0PWM_CHANNEL_NON_INVERTING, .duty_cycle = 50},
      .channel_b = {.mode = HAL_T0PWM_CHANNEL_NON_INVERTING, .duty_cycle = 50},
      .prescaller = presc};
