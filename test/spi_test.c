...
void should_pull_up_ss_on_master_mode(void)
{
  // when
...
void should_initialize_master_data_order(hal_spi_bit_order_t dord,
...
void should_initialize_master_clock_polarity(hal_spi_clock_polarity_t cpol,
                                             uint8_t expected_spcr)
{
  // given
...
void should_initialize_master_clock_phase(hal_spi_clock_phase_t cpha,
                                          uint8_t expected_spcr)
{
  // given
...
void should_initialize_master_clock(hal_spi_prescaller_t presc,
                                    uint8_t expected_spcr,
...
void should_initialize_spi_interrupts()
{
  // given
...
void should_transmit_char(void)
{
  // when
