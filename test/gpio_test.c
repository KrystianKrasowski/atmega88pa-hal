...
void should_define_gpio_as_output(void) {
    void run(hal_gpio_reg_t reg, uint8_t pin_no, uint8_t *avr_ddr, uint8_t expected_mask) {
        // given
        *avr_ddr = 0;
        hal_gpio_def_t def = {
            .dir = HAL_GPIO_OUTPUT,
...
void should_toggle_gpio(void) {
    void run(hal_gpio_reg_t reg, uint8_t pin_no, uint8_t *avr_port, uint8_t expected_mask) {
        // given
        *avr_port = 0;
        hal_gpio_def_t def = {
            .dir = HAL_GPIO_OUTPUT,
...
void should_write_gpio(void) {
    void run(hal_gpio_reg_t reg, uint8_t pin_no, uint8_t *avr_port, uint8_t expected_high_mask) {
        // given
        *avr_port = 0;
        hal_gpio_def_t def = {
            .dir = HAL_GPIO_OUTPUT,
...
void should_read_gpio(void) {
    void run(hal_gpio_reg_t reg, uint8_t pin_no, uint8_t avr_pin_value, uint8_t *avr_pin, hal_gpio_state_t expected_state) {
        // given
