...
void should_define_gpio_as_output(hal_gpio_reg_t reg,
                                  uint8_t pin_no,
                                  uint8_t *avr_ddr,
...
void should_define_gpio_as_input(hal_gpio_reg_t reg,
                                 uint8_t pin_no,
                                 uint8_t *avr_ddr,
                                 uint8_t expected_mask)
{
...
void should_toggle_gpio(hal_gpio_reg_t reg,
                        uint8_t pin_no,
                        uint8_t *avr_port,
                        uint8_t expected_mask)
{
...
void should_write_gpio(hal_gpio_reg_t reg,
                       uint8_t pin_no,
                       uint8_t *avr_port,
...
void should_read_gpio(hal_gpio_reg_t reg,
                      uint8_t pin_no,
