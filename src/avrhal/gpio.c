...
static hal_gpio_register_t const register_map[] = {
    [HAL_GPIO_PB0] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB1] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB2] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB3] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB4] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB5] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB6] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PB7] = HAL_GPIO_REGISTER_B,
    [HAL_GPIO_PC0] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC1] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC2] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC3] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC4] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC5] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PC6] = HAL_GPIO_REGISTER_C,
    [HAL_GPIO_PD0] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD1] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD2] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD3] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD4] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD5] = HAL_GPIO_REGISTER_D,
    [HAL_GPIO_PD6] = HAL_GPIO_REGISTER_D,
